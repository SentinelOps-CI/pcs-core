# Regenerate LabTrust RC artifacts, tool-use and computation fixtures, registry, and hash vectors.
...
try {
    ...
    Write-Host "OK materialized protocol artifacts (LabTrust + tool-use + computation)"
} finally {
    Pop-Location
}
