...
This discharges computation witness result-hash admissibility over the full witness `result_hashes` listing plus verification/signed bundle obligations. It does **not** imply PF-Core trace safety or `LeanKernelChecked`.
-/
...
def concreteComputationWitness : ComputationWitness :=
  {
    ...
    resultHashes := [Hash.ofString "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", Hash.ofString "cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc"],
