...
This discharges computation witness result-hash listing plus verification/signed bundle obligations. Full witness admissibility over all result hashes is not yet codegen-backed. It does **not** imply PF-Core trace safety or `LeanKernelChecked`.
-/
