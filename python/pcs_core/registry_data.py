...
_PF_CORE_ARTIFACT_TYPES = frozenset(
    {
        ...
        "PFCoreEvidenceManifest.v0",
        "PFCoreBundleVerificationResult.v0",
...
_REGISTRY_ENTRIES: dict[str, dict[str, Any]] = {
    ...
    "ResultArtifact.v0": _entry(
        ...
        semantic_checks=[
            _sc("source_commit_not_placeholder", "release_blocking", SCIENTIFIC_COMPUTATION_DEMO),
            _sc("signature_or_digest_valid", "release_blocking", SCIENTIFIC_COMPUTATION_DEMO),
            _sc("payload_bytes_match_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[CERTIFYEDGE, PF, SM, PCS_CORE],
        release_mode_required=True,
    ),
    ...
    "PCSProjectionManifest.v0": _entry(
        artifact_type="PCSProjectionManifest.v0",
        schema="schemas/PCSProjectionManifest.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("projection_entries_nonempty_values", "release_blocking", PCS_CORE),
            _sc("projection_hash_binds_proof_obligation", "release_blocking", PCS_CORE),
        ],
    ...
    "PFCoreEffectFrame.v0": _pf_core_primitive_entry("PFCoreEffectFrame.v0"),
    ...
    "PFCoreTheoremManifest.v0": _entry(
        artifact_type="PFCoreTheoremManifest.v0",
        schema="schemas/PFCoreTheoremManifest.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        required_release_fields=[
            ...
            "final_witness_proposition",
            "theorems",
            "theorem_manifest_digest",
        ],
        semantic_checks=[
            _sc("schema_valid", "release_blocking", PCS_CORE),
            _sc("manifest_digest_matches", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE],
        release_mode_required=False,
    ),
    "PFCoreEvidenceManifest.v0": _entry(
        artifact_type="PFCoreEvidenceManifest.v0",
        schema="schemas/PFCoreEvidenceManifest.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
    ...
    "PFCoreBundleVerificationResult.v0": _entry(
        artifact_type="PFCoreBundleVerificationResult.v0",
        schema="schemas/PFCoreBundleVerificationResult.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
    ...
    "PFCoreKernelManifest.v0": _entry(
        artifact_type="PFCoreKernelManifest.v0",
        schema="schemas/PFCoreKernelManifest.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("unique_kernel_paths", "release_blocking", PCS_CORE),
            _sc("schema_valid", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE],
        release_mode_required=True,
    ),
    "PFCoreReleaseBundleManifest.v0": _entry(
        artifact_type="PFCoreReleaseBundleManifest.v0",
        schema="schemas/PFCoreReleaseBundleManifest.v0.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("schema_valid_before_path_follow", "release_blocking", PCS_CORE),
            _sc("explicit_artifact_type", "release_blocking", PCS_CORE),
            _sc("closed_evidence_digests", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE],
        release_mode_required=True,
    ),
    "ArtifactIntegrity.v1": _entry(
        artifact_type="ArtifactIntegrity.v1",
        schema="schemas/ArtifactIntegrity.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("domain_separated_signature", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE],
        release_mode_required=False,
    ),
    "VerifierProfile.v1": _entry(
        artifact_type="VerifierProfile.v1",
        schema="schemas/VerifierProfile.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer="OVK",
        allowed_runtime_producers=["OVK", PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        required_release_fields=[
            "schema_version",
            "artifact_type",
        ...
        semantic_checks=[
            _sc("explicit_artifact_type", "release_blocking", PCS_CORE),
            _sc("full_source_commit", "release_blocking", PCS_CORE),
            _sc("null_config_digest_slots", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK", LABTRUST],
    ),
    "VerificationResult.v1": _entry(
        artifact_type="VerificationResult.v1",
        schema="schemas/VerificationResult.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer="OVK",
        allowed_runtime_producers=["OVK", PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("fail_closed_decision", "release_blocking", PCS_CORE),
            _sc("typed_indeterminate_or_failure", "release_blocking", PCS_CORE),
            _sc("raw_normalized_digests", "release_blocking", PCS_CORE),
            _sc("no_guarantee_upgrade", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK", LABTRUST],
    ),

    "VerifierInvocationRecord.v1": _entry(
        artifact_type="VerifierInvocationRecord.v1",
        schema="schemas/VerifierInvocationRecord.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer="OVK",
        allowed_runtime_producers=["OVK", PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        consumer_repos=[PCS_CORE, "OVK"],
    ),
    "VerifierReplayReport.v1": _entry(
        artifact_type="VerifierReplayReport.v1",
        schema="schemas/VerifierReplayReport.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer="OVK",
        allowed_runtime_producers=["OVK", PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("explicit_artifact_type", "release_blocking", PCS_CORE),
            _sc("replay_matched_consistency", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK"],
    ),
    "VerifierMutationManifest.v1": _entry(
        artifact_type="VerifierMutationManifest.v1",
        schema="schemas/VerifierMutationManifest.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer="OVK",
        allowed_runtime_producers=["OVK", PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("explicit_artifact_type", "release_blocking", PCS_CORE),
            _sc("production_prohibition_true", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK"],
    ),
    "RewardEvidenceEnvelope.v1": _entry(
        artifact_type="RewardEvidenceEnvelope.v1",
        schema="schemas/RewardEvidenceEnvelope.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=LABTRUST,
        allowed_runtime_producers=[LABTRUST, PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        required_release_fields=[
            "schema_version",
            "artifact_type",
        ...
        semantic_checks=[
            _sc("reward_composition", "release_blocking", PCS_CORE),
            _sc("claims_need_verifier_refs", "release_blocking", PCS_CORE),
            _sc("revoked_profile_gate", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, LABTRUST],
    ),
    "OptimizationCampaignManifest.v1": _entry(
        artifact_type="OptimizationCampaignManifest.v1",
        schema="schemas/OptimizationCampaignManifest.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE, "OVK"],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        required_release_fields=[
            "schema_version",
            "artifact_type",
        ...
        semantic_checks=[
            _sc("access_class_required", "release_blocking", PCS_CORE),
            _sc("cohort_compute_exposure", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK"],
    ),
    "AdjudicationRecord.v1": _entry(
        artifact_type="AdjudicationRecord.v1",
        schema="schemas/AdjudicationRecord.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("rationale_commitment", "release_blocking", PCS_CORE),
            _sc("independence_for_release_grade", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE],
    ),
    "VerifierAssuranceReport.v1": _entry(
        artifact_type="VerifierAssuranceReport.v1",
        schema="schemas/VerifierAssuranceReport.v1.schema.json",
        schema_owner=PCS_CORE,
        runtime_producer=PCS_CORE,
        allowed_runtime_producers=[PCS_CORE],
        allowed_statuses=["Draft", "Validated", "Deprecated"],
        ...
        semantic_checks=[
            _sc("aggregate_count_reconcile", "release_blocking", PCS_CORE),
            _sc("ci_methods_declared", "release_blocking", PCS_CORE),
            _sc("release_grade_adjudication", "release_blocking", PCS_CORE),
            _sc("no_signature_or_digest", "release_blocking", PCS_CORE),
        ],
        consumer_repos=[PCS_CORE, "OVK", LABTRUST],
    ),
